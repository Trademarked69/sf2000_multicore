...
make FROGGY_TYPE=GB300V2 CONSOLE="UAE4ALL"      CORE=cores/working-cores/sf2000-uae-amiga-emulator MAKEFILE=-fMakefile.libretro
make FROGGY_TYPE=GB300V2 CONSOLE="castaway"     CORE=cores/working-cores/sf2000-atarist-emulator MAKEFILE=-fMakefile.libretro
...
make FROGGY_TYPE=GB300V2 CONSOLE="qpsx"         CORE=cores/working-cores/sf2000-qpsx-playstation-emulator # PlayStation
...
make clean FROGGY_TYPE=GB300V2 CONSOLE="Frodo c64"  CORE=cores/working-cores/libretro-frodo EMUTYPE=frodo
make clean FROGGY_TYPE=GB300V2 CONSOLE="Frodo c64sc" CORE=cores/working-cores/libretro-frodo EMUTYPE=frodosc
make FROGGY_TYPE=GB300V2 CONSOLE="Frodo c64sc"  CORE=cores/working-cores/libretro-frodo EMUTYPE=frodosc
make clean FROGGY_TYPE=GB300V2 CONSOLE="Frodo c64sc" CORE=cores/working-cores/libretro-frodo EMUTYPE=frodosc
