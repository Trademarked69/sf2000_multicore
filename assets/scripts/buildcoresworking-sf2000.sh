...
make CONSOLE="UAE4ALL"      CORE=cores/working-cores/sf2000-uae-amiga-emulator MAKEFILE=-fMakefile.libretro
make CONSOLE="castaway"     CORE=cores/working-cores/sf2000-atarist-emulator MAKEFILE=-fMakefile.libretro
...
make CONSOLE="qpsx"         CORE=cores/working-cores/sf2000-qpsx-playstation-emulator # PlayStation
...
make CONSOLE="Frodo c64sc"  CORE=cores/working-cores/libretro-frodo EMUTYPE=frodosc
make clean CONSOLE="Frodo c64sc" CORE=cores/working-cores/libretro-frodo EMUTYPE=frodosc
